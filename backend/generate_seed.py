...
MAJOR_COUNTRIES_CITIES = {
    ...
    "BAE": ["Dubai", "Abu Dhabi", "Sharjah", "Al Ain", "Ajman", "Ras Al Khaimah", "Fujairah", "Umm Al Quwain", "Khor Fakkan", "Dibba Al-Fujairah", "Dhaid", "Jebel Ali", "Ruwais", "Liwa", "Ghayathi", "Madinat Zayed", "Al Dhafra", "Zayed City", "Sweihan", "Al Wathba"],
    ...
    "Kongo": ["Kinşasa", "Lubumbashi", "Mbuji-Mayi", "Kisangani", "Kananga", "Likasi", "Kolwezi", "Tshikapa", "Bukavu", "Kikwit", "Mbandaka", "Matadi", "Uvira", "Butembo", "Gandajika", "Kalemie", "Goma", "Kindu", "Isiro", "Bandundu"],
...
countries_list = [
    ...
    ('TM', 'Türkmenistan'), ('TV', 'Tuvalu'), ('UG', 'Uganda'), ('UA', 'Ukrayna'), ('AE', 'BAE'),
