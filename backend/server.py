...
async def send_survey_invitation(
    ...
    try:
        ...
        base_url = os.environ.get('FRONTEND_URL', 'https://turk-customer-mgmt.preview.emergentagent.com')
...
async def send_expense_receipt_approval_email(receipt, approval_key):
    ...
    try:
        ...
        # Create approval URL
        frontend_url = os.environ.get('FRONTEND_URL', 'https://turk-customer-mgmt.preview.emergentagent.com')
        ...
        <div style="max-width: 600px; margin: 0 auto; background-color: white; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
            ...
            <div style="padding: 30px;">
                ...
                <div style="text-align: center; margin: 30px 0;">
                    ...
                    <a href="https://turk-customer-mgmt.preview.emergentagent.com{pdf_link}" 
