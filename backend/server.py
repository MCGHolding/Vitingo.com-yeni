...
async def send_survey_invitation(
    ...
    try:
        ...
        base_url = os.environ.get('FRONTEND_URL', 'https://tahsilat-app-1.preview.emergentagent.com')
...
async def send_expense_receipt_approval_email(receipt, approval_key):
    ...
    try:
        ...
        # Create approval URL
        frontend_url = os.environ.get('FRONTEND_URL', 'https://tahsilat-app-1.preview.emergentagent.com')
        ...
        <div style="max-width: 600px; margin: 0 auto; background-color: white; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
            ...
            <div style="padding: 30px;">
                ...
                <div style="text-align: center; margin: 30px 0;">
                    ...
                    <a href="https://tahsilat-app-1.preview.emergentagent.com{pdf_link}" 
...
async def create_mock_customers():
    ...
    try:
        ...
        mock_customers = [
            {
                "id": str(uuid.uuid4()),
                "company_short_name": "Anadolu Holding",
                "company_full_name": "Anadolu Endüstri Holding Anonim Şirketi",
                "email": "info@anadoluholding.com.tr",
                "phone": "+90 212 385 65 00",
                "address": "Anadolu Grubu Binası Barbaros Mah. Mor Sümbül Sok. No:7 34746 Ataşehir/İstanbul",
                "city": "İstanbul",
                "country": "Türkiye",
                "sector": "Holding",
                "customer_type": "Firma",
                ...
                "tax_number": "8860094304",
                "created_at": datetime.now().isoformat()
            },
            {
                "id": str(uuid.uuid4()),
                "company_short_name": "Turkcell",
                "company_full_name": "Turkcell İletişim Hizmetleri Anonim Şirketi",
                "email": "kurumsal@turkcell.com.tr",
                "phone": "+90 212 313 10 00",
                "address": "Turkcell Plaza Barbaros Bulvarı No:161 34349 Beşiktaş/İstanbul",
                "city": "İstanbul", 
                "country": "Türkiye",
                ...
                "tax_number": "3530808304",
                "created_at": datetime.now().isoformat()
            },
            {
                "id": str(uuid.uuid4()),
                "company_short_name": "Arçelik",
                "company_full_name": "Arçelik Anonim Şirketi",
                "email": "info@arcelik.com.tr",
                "phone": "+90 216 585 80 00",
                "address": "Arçelik Karaağaç Cad. No:2-6 34445 Sütlüce/İstanbul",
                "city": "İstanbul",
                "country": "Türkiye", 
                "sector": "Beyaz Eşya",
                "customer_type": "Firma",
                ...
                "tax_number": "8850003907",
                "created_at": datetime.now().isoformat()
            },
            {
                "id": str(uuid.uuid4()),
                "company_short_name": "Garanti BBVA",
                "company_full_name": "Türkiye Garanti Bankası Anonim Şirketi",
                "email": "kurumsal@garantibbva.com.tr",
                "phone": "+90 212 318 18 18",
                "address": "Garanti BBVA Genel Müdürlük Levent Nispetiye Cad. No:61 34340 Beşiktaş/İstanbul",
                "city": "İstanbul",
                "country": "Türkiye",
                "sector": "Bankacılık",
                "customer_type": "Firma", 
                ...
                "tax_number": "1261070407",
                "created_at": datetime.now().isoformat()
            },
            {
                "id": str(uuid.uuid4()),
                "company_short_name": "Trendyol",
                "company_full_name": "Trendyol E-Ticaret Anonim Şirketi",
                "email": "kurumsal@trendyol.com",
                "phone": "+90 850 755 88 88",
                "address": "Kemerburgaz Cad. No:3 Vadistanbul AVM A Blok Kat:2 34398 Sarıyer/İstanbul",
                "city": "İstanbul",
                "country": "Türkiye",
                "sector": "E-Ticaret",
                "customer_type": "Firma",
                ...
                "tax_number": "0870877304",
                "created_at": datetime.now().isoformat()
            },
            {
                "id": str(uuid.uuid4()),
                "company_short_name": "Migros",
                "company_full_name": "Migros Ticaret Anonim Şirketi", 
                "email": "info@migros.com.tr",
                "phone": "+90 212 329 21 21",
                ...
                "tax_number": "8690051901",
                "created_at": datetime.now().isoformat()
            },
            {
                "id": str(uuid.uuid4()),
                "company_short_name": "TAV Havalimanları",
                "company_full_name": "TAV Havalimanları Holding Anonim Şirketi",
                "email": "info@tav.aero",
                "phone": "+90 212 463 30 00",
                "address": "TAV İşletme Merkezi Yeşilköy Mah. Havaalanı Cad. No:3 34149 Bakırköy/İstanbul",
                "city": "İstanbul",
                "country": "Türkiye",
                "sector": "Havacılık",
                "customer_type": "Firma",
                "is_candidate": False,
                "website": "www.tav.aero",
                "tax_number": "5770051726",
                "created_at": datetime.now().isoformat()
            },
            {
                "id": str(uuid.uuid4()),
                "company_short_name": "BIM",
                "company_full_name": "BİM Birleşik Mağazalar Anonim Şirketi",
                "email": "info@bim.com.tr", 
                "phone": "+90 212 886 10 95",
                "address": "Esentepe Mah. Büyükdere Cad. Kristal Kule Binası No:215 Kat:2-14 34394 Şişli/İstanbul",
                "city": "İstanbul",
                "country": "Türkiye",
                "sector": "Perakende",
                "customer_type": "Firma",
                ...
                "tax_number": "3890851304",
                "created_at": datetime.now().isoformat()
            },
            {
                "id": str(uuid.uuid4()),
                "company_short_name": "Coca-Cola İçecek",
                "company_full_name": "Coca-Cola İçecek Anonim Şirketi",
                "email": "info@cci.com.tr",
                "phone": "+90 212 336 10 00",
                "address": "Nispetiye Cad. Akmerkez E3 Blok Kat:4 34337 Etiler/İstanbul",
                "city": "İstanbul",
                "country": "Türkiye",
                "sector": "İçecek",
                "customer_type": "Firma", 
                ...
                "tax_number": "2220051304",
                "created_at": datetime.now().isoformat()
            },
            {
                "id": str(uuid.uuid4()),
                "company_short_name": "Enka İnşaat",
                "company_full_name": "Enka İnşaat ve Sanayi Anonim Şirketi",
                "email": "info@enka.com",
                "phone": "+90 212 376 10 00", 
                "address": "Enka Binası İstinye Bayırı Cad. No:1 34460 Sarıyer/İstanbul",
                "city": "İstanbul",
                "country": "Türkiye",
                "sector": "İnşaat",
                "customer_type": "Firma",
                ...
                "tax_number": "5770051901",
                "created_at": datetime.now().isoformat()
            },
            {
                "id": str(uuid.uuid4()),
                "company_short_name": "Vakıfbank",
                "company_full_name": "Türkiye Vakıflar Bankası Türk Anonim Ortaklığı",
                "email": "info@vakifbank.com.tr",
                "phone": "+90 212 455 77 77",
                "address": "Saray Mah. Dr. Adnan Büyükdeniz Cad. No:15 34768 Ümraniye/İstanbul",
                "city": "İstanbul",
                "country": "Türkiye",
                "sector": "Bankacılık",
                "customer_type": "Firma",
                ...
                "tax_number": "1261074507",
                "created_at": datetime.now().isoformat()
            },
            {
                "id": str(uuid.uuid4()),
                "company_short_name": "Eczacıbaşı Holding",
                "company_full_name": "Eczacıbaşı Holding Anonim Şirketi",
                "email": "info@eczacibasi.com.tr",
                "phone": "+90 212 350 80 00",
                "address": "Büyükdere Cad. Ali Kaya Sok. No:7 34394 Levent/İstanbul",
                "city": "İstanbul", 
                "country": "Türkiye",
                "sector": "Holding",
                "customer_type": "Firma",
                ...
                "tax_number": "8860094507",
                "created_at": datetime.now().isoformat()
            },
            {
                "id": str(uuid.uuid4()),
                "company_short_name": "Ford Otosan",
                "company_full_name": "Ford Otomotiv Sanayi Anonim Şirketi",
                "email": "info@fordotosan.com.tr",
                "phone": "+90 262 677 15 00",
                "address": "Akpınar Mah. Hasan Basri Cantürk Bulvarı Ford Otosan Fabrikası 41400 Gebze/Kocaeli",
                "city": "Kocaeli",
                "country": "Türkiye",
                "sector": "Otomotiv",
                "customer_type": "Firma",
                ...
                "tax_number": "4130051304",
                "created_at": datetime.now().isoformat()
            },
            {
                "id": str(uuid.uuid4()),
                "company_short_name": "Halkbank",
                "company_full_name": "Türkiye Halk Bankası Anonim Şirketi",
                "email": "info@halkbank.com.tr",
                "phone": "+90 312 289 80 00",
                "address": "Barbaros Mah. Şebboy Sok. No:4 34746 Ataşehir/İstanbul",
                "city": "İstanbul",
                "country": "Türkiye",
                "sector": "Bankacılık",
                "customer_type": "Firma",
                ...
                "tax_number": "1261074304",
                "created_at": datetime.now().isoformat()
            },
            {
                "id": str(uuid.uuid4()),
                "company_short_name": "Getir",
                "company_full_name": "Getir Perakende Lojistik Anonim Şirketi",
                "email": "kurumsal@getir.com",
                "phone": "+90 850 808 23 83",
                "address": "Rüzgarlıbahçe Mah. Çampınarı Sok. No:4 Beykoz/İstanbul",
                "city": "İstanbul",
                "country": "Türkiye",
                "sector": "Teknoloji",
                "customer_type": "Firma",
                ...
                "tax_number": "0870877507",
                "created_at": datetime.now().isoformat()
            },
            {
                "id": str(uuid.uuid4()),
                "company_short_name": "Pegasus Hava Yolları",
                "company_full_name": "Pegasus Hava Taşımacılığı Anonim Şirketi",
                "email": "info@flypgs.com",
                "phone": "+90 850 250 67 77",
                "address": "Aeropark Atatürk Havalimanı Karşısı 34149 Bakırköy/İstanbul",
                "city": "İstanbul",
                "country": "Türkiye",
                "sector": "Havacılık",
                "customer_type": "Firma",
                ...
                "tax_number": "8760051304",
                "created_at": datetime.now().isoformat()
            },
            {
                "id": str(uuid.uuid4()),
                "company_short_name": "Akbank",
                "company_full_name": "Akbank Türk Anonim Şirketi",
                "email": "info@akbank.com.tr",
                ...
                "tax_number": "1261070304",
                "created_at": datetime.now().isoformat()
            },
            {
                "id": str(uuid.uuid4()),
                "company_short_name": "THY",
                "company_full_name": "Türk Hava Yolları Anonim Ortaklığı",
                "email": "info@thy.com",
                "phone": "+90 212 463 63 63",
                "address": "THY Genel Müdürlük Binası Atatürk Havalimanı 34149 Yeşilköy/İstanbul",
                "city": "İstanbul",
                "country": "Türkiye",
                "sector": "Havacılık",
                "customer_type": "Firma",
                ...
                "tax_number": "2200051304",
                "created_at": datetime.now().isoformat()
            },
            {
                "id": str(uuid.uuid4()),
                "company_short_name": "Teknosa",
                "company_full_name": "Teknosa İç ve Dış Ticaret Anonim Şirketi",
                "email": "info@teknosa.com",
                "phone": "+90 212 467 20 00",
                "address": "Meydan Sokak No:1 Maslak 34485 Sarıyer/İstanbul",
                "city": "İstanbul",
                "country": "Türkiye",
                "sector": "Teknoloji",
                "customer_type": "Firma",
                "is_candidate": False,
                "website": "www.teknosa.com",
                "tax_number": "0870877401",
                "created_at": datetime.now().isoformat()
            },
            {
                "id": str(uuid.uuid4()),
                "company_short_name": "Zorlu Holding",
                "company_full_name": "Zorlu Holding Anonim Şirketi",
                "email": "info@zorlu.com.tr",
                "phone": "+90 212 456 20 00",
                "address": "Zorlu Center Levazım Mah. Koru Sok. No:2 34340 Beşiktaş/İstanbul",
                "city": "İstanbul",
                "country": "Türkiye",
                "sector": "Holding",
                "customer_type": "Firma",
                "is_candidate": False,
                "website": "www.zorlu.com",
                "tax_number": "8860094401",
                "created_at": datetime.now().isoformat()
            },
            {
                "id": str(uuid.uuid4()),
                "company_short_name": "Siemens Türkiye",
                "company_full_name": "Siemens Sanayi ve Ticaret Anonim Şirketi",
                "email": "info@siemens.com.tr",
                "phone": "+90 216 459 62 62",
                "address": "İTÜ Ayazağa Kampüsü Teknokent ARI-4 Binası 34469 Maslak/İstanbul",
                "city": "İstanbul",
                "country": "Türkiye",
                "sector": "Teknoloji",
                "customer_type": "Firma",
                "is_candidate": False,
                "website": "www.siemens.com.tr",
                "tax_number": "1330051304",
                "created_at": datetime.now().isoformat()
            },
            {
                "id": str(uuid.uuid4()),
                "company_short_name": "Borusan Holding",
                "company_full_name": "Borusan Holding Anonim Şirketi",
                "email": "info@borusan.com",
                "phone": "+90 212 393 14 14",
                "address": "Borusan İstanbul Perpa Ticaret Merkezi A Blok Kat:13 No:2032-2052 34384 Okmeydanı/İstanbul",
                "city": "İstanbul",
                "country": "Türkiye", 
                "sector": "Holding",
                "customer_type": "Firma",
                ...
                "tax_number": "8860094202",
                "created_at": datetime.now().isoformat()
            },
            {
                "id": str(uuid.uuid4()),
                "company_short_name": "Vestel",
                "company_full_name": "Vestel Elektronik Sanayi ve Ticaret Anonim Şirketi",
                "email": "info@vestel.com.tr",
                "phone": "+90 236 814 62 62",
                "address": "Organize Sanayi Bölgesi 45030 Yunusemre/Manisa",
                "city": "Manisa",
                "country": "Türkiye",
                "sector": "Elektronik",
                "customer_type": "Firma",
                ...
                "tax_number": "4500051304",
                "created_at": datetime.now().isoformat()
            },
            {
                "id": str(uuid.uuid4()),
                "company_short_name": "CarrefourSA",
                "company_full_name": "CarrefourSA Carrefour Sabancı Ticaret Merkezi Anonim Şirketi",
                "email": "info@carrefoursa.com",
                "phone": "+90 212 385 74 00",
                "address": "Sabancı Center 4. Levent 34330 İstanbul",
                "city": "İstanbul",
                "country": "Türkiye",
                "sector": "Perakende",
                "customer_type": "Firma",
                "is_candidate": False,
                "website": "www.carrefoursa.com",
                "tax_number": "8690051702",
                "created_at": datetime.now().isoformat()
            },
            {
                "id": str(uuid.uuid4()),
                "company_short_name": "Şişe Cam",
                "company_full_name": "Türkiye Şişe ve Cam Fabrikaları Anonim Şirketi",
                "email": "info@sisecam.com",
                "phone": "+90 212 350 50 50",
                "address": "İçerenköy Mah. Umut Sok. No:10 Ataşehir/İstanbul",
                "city": "İstanbul",
                "country": "Türkiye",
                "sector": "Cam",
                "customer_type": "Firma",
                ...
                "tax_number": "2860051304",
                "created_at": datetime.now().isoformat()
            },
            {
                "id": str(uuid.uuid4()),
                "company_short_name": "Doğan Holding",
                "company_full_name": "Doğan Şirketler Grubu Holding Anonim Şirketi",
                "email": "info@dogan.com.tr",
                "phone": "+90 212 335 22 22",
                "address": "Nispetiye Cad. No:13 34340 Etiler/İstanbul",
                "city": "İstanbul",
                "country": "Türkiye",
                "sector": "Medya",
                "customer_type": "Firma",
                "is_candidate": False,
                "website": "www.dogan.com.tr",
                "tax_number": "8860094101",
                "created_at": datetime.now().isoformat()
            },
            {
                "id": str(uuid.uuid4()),
                "company_short_name": "Yemeksepeti",
                "company_full_name": "Yemeksepeti Elektronik İletişim Tanıtım ve Pazarlama Ltd. Şti.",
                "email": "kurumsal@yemeksepeti.com",
                "phone": "+90 850 808 02 02",
                "address": "Maslak Mah. Büyükdere Cad. Spine Tower No:243 Kat:15-16 34398 Sarıyer/İstanbul",
                "city": "İstanbul",
                "country": "Türkiye",
                "sector": "Teknoloji",
                "customer_type": "Firma",
                ...
                "tax_number": "0870877201",
                "created_at": datetime.now().isoformat()
            },
            {
                "id": str(uuid.uuid4()),
                "company_short_name": "TOFAŞ",
                "company_full_name": "Tofaş Türk Otomobil Fabrikası Anonim Şirketi",
                "email": "info@tofas.com.tr",
                "phone": "+90 224 261 81 10",
                "address": "Fiat Cad. No:1 16369 Osmangazi/Bursa",
                "city": "Bursa",
                "country": "Türkiye",
                "sector": "Otomotiv",
                "customer_type": "Firma",
                ...
                "tax_number": "1610051304",
                "created_at": datetime.now().isoformat()
            },
            {
                "id": str(uuid.uuid4()),
                "company_short_name": "Petkim",
                "company_full_name": "Petkim Petrokimya Holding Anonim Şirketi",
                "email": "info@petkim.com.tr",
                "phone": "+90 232 435 33 43",
                "address": "Petkim Sitesi 35800 Aliağa/İzmir",
                "city": "İzmir",
                "country": "Türkiye",
                "sector": "Petrokimya",
                "customer_type": "Firma",
                ...
                "tax_number": "3500051304",
                "created_at": datetime.now().isoformat()
            },
            {
                "id": str(uuid.uuid4()),
                "company_short_name": "İş Bankası",
                "company_full_name": "Türkiye İş Bankası Anonim Şirketi",
                "email": "info@isbank.com.tr",
                "phone": "+90 212 316 00 00",
                "address": "İş Kuleleri Kule 1 4. Levent 34330 İstanbul",
                "city": "İstanbul",
                "country": "Türkiye",
                "sector": "Bankacılık",
                "customer_type": "Firma",
