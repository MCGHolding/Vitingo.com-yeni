...
async def seed_comprehensive_geo_data():
    ...
    try:
        ...
        if country_count < 100:  # If less than 100 countries, seed more
            ...
            # Insert countries (avoid duplicates)
            ...
            logger.info(f"Seeded {len(comprehensive_countries)} countries")
            
            # Add major cities for key countries
            major_cities = [
                # Turkey
            ...
            # Insert cities (avoid duplicates)
            for city_data in major_cities:
                existing = await db.cities.find_one({"name": city_data["name"], "country": city_data["country"]})
                if not existing:
...
async def get_cities(country_code: str, query: str = ""):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=str(e))
    {"code": "AF", "name": "Afghanistan", "tr_name": "Afganistan"},
    {"code": "AG", "name": "Antigua and Barbuda", "tr_name": "Antigua ve Barbuda"},
    {"code": "AI", "name": "Anguilla", "tr_name": "Anguilla"},
    {"code": "AL", "name": "Albania", "tr_name": "Arnavutluk"},
    {"code": "AM", "name": "Armenia", "tr_name": "Ermenistan"},
    {"code": "AO", "name": "Angola", "tr_name": "Angola"},
    {"code": "AQ", "name": "Antarctica", "tr_name": "Antarktika"},
    {"code": "AR", "name": "Argentina", "tr_name": "Arjantin"},
    {"code": "AS", "name": "American Samoa", "tr_name": "Amerikan Samoası"},
    {"code": "AT", "name": "Austria", "tr_name": "Avusturya"},
    {"code": "AU", "name": "Australia", "tr_name": "Avustralya"},
    {"code": "AW", "name": "Aruba", "tr_name": "Aruba"},
    {"code": "AX", "name": "Aland Islands", "tr_name": "Åland Adaları"},
    {"code": "AZ", "name": "Azerbaijan", "tr_name": "Azerbaycan"},
    {"code": "BA", "name": "Bosnia and Herzegovina", "tr_name": "Bosna Hersek"},
    {"code": "BB", "name": "Barbados", "tr_name": "Barbados"},
    {"code": "BD", "name": "Bangladesh", "tr_name": "Bangladeş"},
    {"code": "BE", "name": "Belgium", "tr_name": "Belçika"},
    {"code": "BF", "name": "Burkina Faso", "tr_name": "Burkina Faso"},
    {"code": "BG", "name": "Bulgaria", "tr_name": "Bulgaristan"},
    {"code": "BH", "name": "Bahrain", "tr_name": "Bahreyn"},
    {"code": "BI", "name": "Burundi", "tr_name": "Burundi"},
    {"code": "BJ", "name": "Benin", "tr_name": "Benin"},
    {"code": "BL", "name": "Saint Barthelemy", "tr_name": "Saint Barthélemy"},
    {"code": "BM", "name": "Bermuda", "tr_name": "Bermuda"},
    {"code": "BN", "name": "Brunei", "tr_name": "Brunei"},
    {"code": "BO", "name": "Bolivia", "tr_name": "Bolivya"},
    {"code": "BQ", "name": "Bonaire, Saint Eustatius and Saba ", "tr_name": "Bonaire"},
    {"code": "BR", "name": "Brazil", "tr_name": "Brezilya"},
    {"code": "BS", "name": "Bahamas", "tr_name": "Bahamalar"},
    {"code": "BT", "name": "Bhutan", "tr_name": "Bhutan"},
    {"code": "BV", "name": "Bouvet Island", "tr_name": "Bouvet Adası"},
    {"code": "BW", "name": "Botswana", "tr_name": "Botsvana"},
    {"code": "BY", "name": "Belarus", "tr_name": "Belarus"},
    {"code": "BZ", "name": "Belize", "tr_name": "Belize"},
    {"code": "CA", "name": "Canada", "tr_name": "Kanada"},
    {"code": "CC", "name": "Cocos Islands", "tr_name": "Cocos Adaları"},
    {"code": "CD", "name": "Democratic Republic of the Congo", "tr_name": "Kongo Demokratik Cumhuriyeti"},
    {"code": "CF", "name": "Central African Republic", "tr_name": "Orta Afrika Cumhuriyeti"},
    {"code": "CG", "name": "Republic of the Congo", "tr_name": "Kongo Cumhuriyeti"},
    {"code": "CH", "name": "Switzerland", "tr_name": "İsviçre"},
    {"code": "CI", "name": "Ivory Coast", "tr_name": "Fildişi Sahili"},
    {"code": "CK", "name": "Cook Islands", "tr_name": "Cook Adaları"},
    {"code": "CL", "name": "Chile", "tr_name": "Şili"},
    {"code": "CM", "name": "Cameroon", "tr_name": "Kamerun"},
    {"code": "CN", "name": "China", "tr_name": "Çin"},
    {"code": "CO", "name": "Colombia", "tr_name": "Kolombiya"},
    {"code": "CR", "name": "Costa Rica", "tr_name": "Kosta Rika"},
    {"code": "CU", "name": "Cuba", "tr_name": "Küba"},
    {"code": "CV", "name": "Cape Verde", "tr_name": "Yeşil Burun Adaları"},
    {"code": "CW", "name": "Curacao", "tr_name": "Curaçao"},
    {"code": "CX", "name": "Christmas Island", "tr_name": "Christmas Adası"},
    {"code": "CY", "name": "Cyprus", "tr_name": "Kıbrıs"},
    {"code": "CZ", "name": "Czech Republic", "tr_name": "Çek Cumhuriyeti"},
    {"code": "DE", "name": "Germany", "tr_name": "Almanya"},
    {"code": "DJ", "name": "Djibouti", "tr_name": "Cibuti"},
    {"code": "DK", "name": "Denmark", "tr_name": "Danimarka"},
    {"code": "DM", "name": "Dominica", "tr_name": "Dominika"},
    {"code": "DO", "name": "Dominican Republic", "tr_name": "Dominik Cumhuriyeti"},
    {"code": "DZ", "name": "Algeria", "tr_name": "Cezayir"},
    {"code": "EC", "name": "Ecuador", "tr_name": "Ekvador"},
    {"code": "EE", "name": "Estonia", "tr_name": "Estonya"},
    {"code": "EG", "name": "Egypt", "tr_name": "Mısır"},
    {"code": "EH", "name": "Western Sahara", "tr_name": "Batı Sahra"},
    {"code": "ER", "name": "Eritrea", "tr_name": "Eritre"},
    {"code": "ES", "name": "Spain", "tr_name": "İspanya"},
    {"code": "ET", "name": "Ethiopia", "tr_name": "Etiyopya"},
    {"code": "FI", "name": "Finland", "tr_name": "Finlandiya"},
    {"code": "FJ", "name": "Fiji", "tr_name": "Fiji"},
    {"code": "FK", "name": "Falkland Islands", "tr_name": "Falkland Adaları"},
    {"code": "FM", "name": "Micronesia", "tr_name": "Mikronezya"},
    {"code": "FO", "name": "Faroe Islands", "tr_name": "Faroe Adaları"},
    {"code": "FR", "name": "France", "tr_name": "Fransa"},
    {"code": "GA", "name": "Gabon", "tr_name": "Gabon"},
    {"code": "GB", "name": "United Kingdom", "tr_name": "Birleşik Krallık"},
    {"code": "GD", "name": "Grenada", "tr_name": "Grenada"},
    {"code": "GE", "name": "Georgia", "tr_name": "Gürcistan"},
    {"code": "GF", "name": "French Guiana", "tr_name": "Fransız Guyanası"},
    {"code": "GG", "name": "Guernsey", "tr_name": "Guernsey"},
    {"code": "GH", "name": "Ghana", "tr_name": "Gana"},
    {"code": "GI", "name": "Gibraltar", "tr_name": "Cebelitarık"},
    {"code": "GL", "name": "Greenland", "tr_name": "Grönland"},
    {"code": "GM", "name": "Gambia", "tr_name": "Gambiya"},
    {"code": "GN", "name": "Guinea", "tr_name": "Gine"},
    {"code": "GP", "name": "Guadeloupe", "tr_name": "Guadeloupe"},
    {"code": "GQ", "name": "Equatorial Guinea", "tr_name": "Ekvator Ginesi"},
    {"code": "GR", "name": "Greece", "tr_name": "Yunanistan"},
    {"code": "GS", "name": "South Georgia and the South Sandwich Islands", "tr_name": "Güney Georgia"},
    {"code": "GT", "name": "Guatemala", "tr_name": "Guatemala"},
    {"code": "GU", "name": "Guam", "tr_name": "Guam"},
    {"code": "GW", "name": "Guinea-Bissau", "tr_name": "Gine-Bissau"},
    {"code": "GY", "name": "Guyana", "tr_name": "Guyana"},
    {"code": "HK", "name": "Hong Kong", "tr_name": "Hong Kong"},
    {"code": "HM", "name": "Heard Island and McDonald Islands", "tr_name": "Heard Adası"},
    {"code": "HN", "name": "Honduras", "tr_name": "Honduras"},
    {"code": "HR", "name": "Croatia", "tr_name": "Hırvatistan"},
    {"code": "HT", "name": "Haiti", "tr_name": "Haiti"},
    {"code": "HU", "name": "Hungary", "tr_name": "Macaristan"},
    {"code": "ID", "name": "Indonesia", "tr_name": "Endonezya"},
    {"code": "IE", "name": "Ireland", "tr_name": "İrlanda"},
    {"code": "IL", "name": "Israel", "tr_name": "İsrail"},
    {"code": "IM", "name": "Isle of Man", "tr_name": "Man Adası"},
    {"code": "IN", "name": "India", "tr_name": "Hindistan"},
    {"code": "IO", "name": "British Indian Ocean Territory", "tr_name": "İngiliz Hint Okyanusu Bölgesi"},
    {"code": "IQ", "name": "Iraq", "tr_name": "Irak"},
    {"code": "IR", "name": "Iran", "tr_name": "İran"},
    {"code": "IS", "name": "Iceland", "tr_name": "İzlanda"},
    {"code": "IT", "name": "Italy", "tr_name": "İtalya"},
    {"code": "JE", "name": "Jersey", "tr_name": "Jersey"},
    {"code": "JM", "name": "Jamaica", "tr_name": "Jamaika"},
    {"code": "JO", "name": "Jordan", "tr_name": "Ürdün"},
    {"code": "JP", "name": "Japan", "tr_name": "Japonya"},
    {"code": "KE", "name": "Kenya", "tr_name": "Kenya"},
    {"code": "KG", "name": "Kyrgyzstan", "tr_name": "Kırgızistan"},
    {"code": "KH", "name": "Cambodia", "tr_name": "Kamboçya"},
    {"code": "KI", "name": "Kiribati", "tr_name": "Kiribati"},
    {"code": "KM", "name": "Comoros", "tr_name": "Komorlar"},
    {"code": "KN", "name": "Saint Kitts and Nevis", "tr_name": "Saint Kitts ve Nevis"},
    {"code": "KP", "name": "North Korea", "tr_name": "Kuzey Kore"},
    {"code": "KR", "name": "South Korea", "tr_name": "Güney Kore"},
    {"code": "KW", "name": "Kuwait", "tr_name": "Kuveyt"},
    {"code": "KY", "name": "Cayman Islands", "tr_name": "Cayman Adaları"},
    {"code": "KZ", "name": "Kazakhstan", "tr_name": "Kazakistan"},
    {"code": "LA", "name": "Laos", "tr_name": "Laos"},
    {"code": "LB", "name": "Lebanon", "tr_name": "Lübnan"},
    {"code": "LC", "name": "Saint Lucia", "tr_name": "Saint Lucia"},
    {"code": "LI", "name": "Liechtenstein", "tr_name": "Liechtenstein"},
    {"code": "LK", "name": "Sri Lanka", "tr_name": "Sri Lanka"},
    {"code": "LR", "name": "Liberia", "tr_name": "Liberya"},
    {"code": "LS", "name": "Lesotho", "tr_name": "Lesotho"},
    {"code": "LT", "name": "Lithuania", "tr_name": "Litvanya"},
    {"code": "LU", "name": "Luxembourg", "tr_name": "Lüksemburg"},
    {"code": "LV", "name": "Latvia", "tr_name": "Letonya"},
    {"code": "LY", "name": "Libya", "tr_name": "Libya"},
    {"code": "MA", "name": "Morocco", "tr_name": "Fas"},
    {"code": "MC", "name": "Monaco", "tr_name": "Monako"},
    {"code": "MD", "name": "Moldova", "tr_name": "Moldova"},
    {"code": "ME", "name": "Montenegro", "tr_name": "Karadağ"},
    {"code": "MF", "name": "Saint Martin", "tr_name": "Saint Martin"},
    {"code": "MG", "name": "Madagascar", "tr_name": "Madagaskar"},
    {"code": "MH", "name": "Marshall Islands", "tr_name": "Marshall Adaları"},
    {"code": "MK", "name": "Macedonia", "tr_name": "Kuzey Makedonya"},
    {"code": "ML", "name": "Mali", "tr_name": "Mali"},
    {"code": "MM", "name": "Myanmar", "tr_name": "Myanmar"},
    {"code": "MN", "name": "Mongolia", "tr_name": "Moğolistan"},
    {"code": "MO", "name": "Macao", "tr_name": "Makao"},
    {"code": "MP", "name": "Northern Mariana Islands", "tr_name": "Kuzey Mariana Adaları"},
    {"code": "MQ", "name": "Martinique", "tr_name": "Martinique"},
    {"code": "MR", "name": "Mauritania", "tr_name": "Moritanya"},
    {"code": "MS", "name": "Montserrat", "tr_name": "Montserrat"},
    {"code": "MT", "name": "Malta", "tr_name": "Malta"},
    {"code": "MU", "name": "Mauritius", "tr_name": "Mauritius"},
    {"code": "MV", "name": "Maldives", "tr_name": "Maldivler"},
    {"code": "MW", "name": "Malawi", "tr_name": "Malavi"},
    {"code": "MX", "name": "Mexico", "tr_name": "Meksika"},
    {"code": "MY", "name": "Malaysia", "tr_name": "Malezya"},
    {"code": "MZ", "name": "Mozambique", "tr_name": "Mozambik"},
    {"code": "NA", "name": "Namibia", "tr_name": "Namibya"},
    {"code": "NC", "name": "New Caledonia", "tr_name": "Yeni Kaledonya"},
    {"code": "NE", "name": "Niger", "tr_name": "Nijer"},
    {"code": "NF", "name": "Norfolk Island", "tr_name": "Norfolk Adası"},
    {"code": "NG", "name": "Nigeria", "tr_name": "Nijerya"},
    {"code": "NI", "name": "Nicaragua", "tr_name": "Nikaragua"},
    {"code": "NL", "name": "Netherlands", "tr_name": "Hollanda"},
    {"code": "NO", "name": "Norway", "tr_name": "Norveç"},
    {"code": "NP", "name": "Nepal", "tr_name": "Nepal"},
    {"code": "NR", "name": "Nauru", "tr_name": "Nauru"},
    {"code": "NU", "name": "Niue", "tr_name": "Niue"},
    {"code": "NZ", "name": "New Zealand", "tr_name": "Yeni Zelanda"},
    {"code": "OM", "name": "Oman", "tr_name": "Umman"},
    {"code": "PA", "name": "Panama", "tr_name": "Panama"},
    {"code": "PE", "name": "Peru", "tr_name": "Peru"},
    {"code": "PF", "name": "French Polynesia", "tr_name": "Fransız Polinezyası"},
    {"code": "PG", "name": "Papua New Guinea", "tr_name": "Papua Yeni Gine"},
    {"code": "PH", "name": "Philippines", "tr_name": "Filipinler"},
    {"code": "PK", "name": "Pakistan", "tr_name": "Pakistan"},
    {"code": "PL", "name": "Poland", "tr_name": "Polonya"},
    {"code": "PM", "name": "Saint Pierre and Miquelon", "tr_name": "Saint Pierre ve Miquelon"},
    {"code": "PN", "name": "Pitcairn", "tr_name": "Pitcairn"},
    {"code": "PR", "name": "Puerto Rico", "tr_name": "Porto Riko"},
    {"code": "PS", "name": "Palestinian Territory", "tr_name": "Filistin"},
    {"code": "PT", "name": "Portugal", "tr_name": "Portekiz"},
    {"code": "PW", "name": "Palau", "tr_name": "Palau"},
    {"code": "PY", "name": "Paraguay", "tr_name": "Paraguay"},
    {"code": "QA", "name": "Qatar", "tr_name": "Katar"},
    {"code": "RE", "name": "Reunion", "tr_name": "Réunion"},
    {"code": "RO", "name": "Romania", "tr_name": "Romanya"},
    {"code": "RS", "name": "Serbia", "tr_name": "Sırbistan"},
    {"code": "RU", "name": "Russia", "tr_name": "Rusya"},
    {"code": "RW", "name": "Rwanda", "tr_name": "Ruanda"},
    {"code": "SA", "name": "Saudi Arabia", "tr_name": "Suudi Arabistan"},
    {"code": "SB", "name": "Solomon Islands", "tr_name": "Solomon Adaları"},
    {"code": "SC", "name": "Seychelles", "tr_name": "Seyşeller"},
    {"code": "SD", "name": "Sudan", "tr_name": "Sudan"},
    {"code": "SE", "name": "Sweden", "tr_name": "İsveç"},
    {"code": "SG", "name": "Singapore", "tr_name": "Singapur"},
    {"code": "SH", "name": "Saint Helena", "tr_name": "Saint Helena"},
    {"code": "SI", "name": "Slovenia", "tr_name": "Slovenya"},
    {"code": "SJ", "name": "Svalbard and Jan Mayen", "tr_name": "Svalbard ve Jan Mayen"},
    {"code": "SK", "name": "Slovakia", "tr_name": "Slovakya"},
    {"code": "SL", "name": "Sierra Leone", "tr_name": "Sierra Leone"},
    {"code": "SM", "name": "San Marino", "tr_name": "San Marino"},
    {"code": "SN", "name": "Senegal", "tr_name": "Senegal"},
    {"code": "SO", "name": "Somalia", "tr_name": "Somali"},
    {"code": "SR", "name": "Suriname", "tr_name": "Surinam"},
    {"code": "SS", "name": "South Sudan", "tr_name": "Güney Sudan"},
    {"code": "ST", "name": "Sao Tome and Principe", "tr_name": "São Tomé ve Príncipe"},
    {"code": "SV", "name": "El Salvador", "tr_name": "El Salvador"},
    {"code": "SX", "name": "Sint Maarten", "tr_name": "Sint Maarten"},
    {"code": "SY", "name": "Syria", "tr_name": "Suriye"},
    {"code": "SZ", "name": "Swaziland", "tr_name": "Eswatini"},
    {"code": "TC", "name": "Turks and Caicos Islands", "tr_name": "Turks ve Caicos Adaları"},
    {"code": "TD", "name": "Chad", "tr_name": "Çad"},
    {"code": "TF", "name": "French Southern Territories", "tr_name": "Fransız Güney Toprakları"},
    {"code": "TG", "name": "Togo", "tr_name": "Togo"},
    {"code": "TH", "name": "Thailand", "tr_name": "Tayland"},
    {"code": "TJ", "name": "Tajikistan", "tr_name": "Tacikistan"},
    {"code": "TK", "name": "Tokelau", "tr_name": "Tokelau"},
    {"code": "TL", "name": "East Timor", "tr_name": "Doğu Timor"},
    {"code": "TM", "name": "Turkmenistan", "tr_name": "Türkmenistan"},
    {"code": "TN", "name": "Tunisia", "tr_name": "Tunus"},
    {"code": "TO", "name": "Tonga", "tr_name": "Tonga"},
    {"code": "TR", "name": "Turkey", "tr_name": "Türkiye"},
    {"code": "TT", "name": "Trinidad and Tobago", "tr_name": "Trinidad ve Tobago"},
    {"code": "TV", "name": "Tuvalu", "tr_name": "Tuvalu"},
    {"code": "TW", "name": "Taiwan", "tr_name": "Tayvan"},
    {"code": "TZ", "name": "Tanzania", "tr_name": "Tanzanya"},
    {"code": "UA", "name": "Ukraine", "tr_name": "Ukrayna"},
    {"code": "UG", "name": "Uganda", "tr_name": "Uganda"},
    {"code": "UM", "name": "United States Minor Outlying Islands", "tr_name": "ABD Dış Adaları"},
    {"code": "US", "name": "United States", "tr_name": "Amerika Birleşik Devletleri"},
    {"code": "UY", "name": "Uruguay", "tr_name": "Uruguay"},
    {"code": "UZ", "name": "Uzbekistan", "tr_name": "Özbekistan"},
    {"code": "VA", "name": "Vatican", "tr_name": "Vatikan"},
    {"code": "VC", "name": "Saint Vincent and the Grenadines", "tr_name": "Saint Vincent ve Grenadinler"},
    {"code": "VE", "name": "Venezuela", "tr_name": "Venezuela"},
    {"code": "VG", "name": "British Virgin Islands", "tr_name": "İngiliz Virgin Adaları"},
    {"code": "VI", "name": "U.S. Virgin Islands", "tr_name": "ABD Virgin Adaları"},
    {"code": "VN", "name": "Vietnam", "tr_name": "Vietnam"},
    {"code": "VU", "name": "Vanuatu", "tr_name": "Vanuatu"},
    {"code": "WF", "name": "Wallis and Futuna", "tr_name": "Wallis ve Futuna"},
    {"code": "WS", "name": "Samoa", "tr_name": "Samoa"},
    {"code": "YE", "name": "Yemen", "tr_name": "Yemen"},
    {"code": "YT", "name": "Mayotte", "tr_name": "Mayotte"},
    {"code": "ZA", "name": "South Africa", "tr_name": "Güney Afrika"},
    {"code": "ZM", "name": "Zambia", "tr_name": "Zambiya"},
    {"code": "ZW", "name": "Zimbabwe", "tr_name": "Zimbabve"}
]
...
# Major world cities by country (sample data)
WORLD_CITIES = {
    ...
    "TR": TURKEY_CITIES  # Use Turkey cities defined above
}
    ...
    try:
        ...
        if query:
            ...
            countries = [
                ...
                if query_lower in country["tr_name"].lower() or 
                   query_lower in country["name"].lower() or
...
async def get_cities(country_code: str, query: str = ""):
    ...
    try:
        ...
        cities = WORLD_CITIES.get(country_code_upper, [])
        ...
        # Return as list of objects for consistency with frontend expectations
        return [{"name": city, "country_code": country_code_upper} for city in cities]
    except Exception as e:
        logger.error(f"Error fetching cities: {str(e)}")
        raise HTTPException(status_code=500, detail=str(e))
