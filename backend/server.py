from fastapi import FastAPI, APIRouter, HTTPException, File, UploadFile, Form, Request, WebSocket, WebSocketDisconnect
...
async def send_survey_invitation(
    ...
    try:
        ...
        base_url = os.environ.get('FRONTEND_URL', 'https://crmplus-2.preview.emergentagent.com')
...
async def send_expense_receipt_approval_email(receipt, approval_key):
    ...
    try:
        ...
        # Create approval URL
        frontend_url = os.environ.get('FRONTEND_URL', 'https://crmplus-2.preview.emergentagent.com')
...
async def create_opportunity_stage(stage_input: StageCreate):
    ...
    try:
        # Generate value from label (lowercase, replace spaces with underscores)
        value = stage_input.label.lower().replace(' ', '_').replace('ı', 'i').replace('İ', 'i').replace('ü', 'u').replace('Ü', 'u').replace('ö', 'o').replace('Ö', 'o').replace('ş', 's').replace('Ş', 's').replace('ğ', 'g').replace('Ğ', 'g').replace('ç', 'c').replace('Ç', 'c')
        ...
        <div style="max-width: 600px; margin: 0 auto; background-color: white; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
            ...
            <div style="padding: 30px;">
                ...
                <div style="text-align: center; margin: 30px 0;">
                    ...
                    <a href="https://crmplus-2.preview.emergentagent.com{pdf_link}" 
