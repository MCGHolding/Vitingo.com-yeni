...
BACKEND_URL = "https://customer-portal-13.preview.emergentagent.com"
...
if __name__ == "__main__":
    print("🚀 STARTING CUSTOMER PROSPECTS DEBUG TESTING")
    print("=" * 80)
    print(f"Backend URL: {BACKEND_URL}")
    print("Testing customer prospects functionality to debug why prospects are not showing in CustomerProspectsPage:")
    print("1. Test GET /api/customer-prospects endpoint to see current prospects in database")
    print("2. Create a new prospect via POST /api/customer-prospects with test data:")
    print("   - company_short_name: 'Test Aday Debug'")
    print("   - email: 'debug@testaday.com'")
    print("   - country: 'TR'")
    print("   - city: 'Istanbul'")
    print("   - sector: 'Teknoloji'")
    print("   - is_candidate: true")
    print("3. Test GET /api/customer-prospects again to verify the new prospect was saved")
    print("4. Check the data structure returned to ensure it matches what CustomerProspectsPage expects")
    print("5. Check if there are any existing prospects in the database that should be showing")
    print("\nThis will help identify if the issue is in backend storage or frontend display.")
    print("=" * 80)
    
    # Run customer prospects debug test
    success = test_customer_prospects_debug_functionality()
    
    if success:
        print("\n🎯 CUSTOMER PROSPECTS DEBUG TESTING COMPLETED SUCCESSFULLY!")
        print("✅ All customer-prospects endpoints working correctly")
        print("✅ Database persistence verified")
        print("✅ Data structure matches frontend expectations")
        print("✅ Debug prospect created and verified")
        print("✅ Backend functionality is working correctly")
        print("\n🔍 DIAGNOSIS:")
        print("If CustomerProspectsPage is still not showing prospects, the issue is in the frontend:")
        print("• Check REACT_APP_BACKEND_URL configuration")
        print("• Verify API calls are being made in browser network tab")
        print("• Check frontend component state management")
        print("• Verify data rendering logic in CustomerProspectsPage")
        print("• Check for JavaScript errors in browser console")
        sys.exit(0)
    else:
        print("\n❌ CUSTOMER PROSPECTS DEBUG TESTING FAILED!")
        print("Backend API issues found that need to be addressed.")
        print("The customer prospects display issue may be in the backend.")
        sys.exit(1)