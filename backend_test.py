...
if __name__ == "__main__":
    print("🚀 STARTING CUSTOMERS AND SUPPLIERS ENDPOINTS TESTING")
    print("=" * 80)
    print(f"Backend URL: {BACKEND_URL}")
    print("Testing customers and suppliers endpoints for dropdown data availability:")
    print("1. Test GET /api/customers endpoint to see customer companies")
    print("2. Test GET /api/suppliers endpoint to see supplier companies")
    print("3. Verify the data structure returned by both endpoints")
    print("4. Check if these endpoints return company names that can be used in dropdowns")
    print("\nThis will help us understand what data is available for the dynamic dropdowns in the person form.")
    print("=" * 80)
    
    # Run customers and suppliers endpoints test
    success = test_customers_and_suppliers_endpoints()
    
    if success:
        print("\n🎯 CUSTOMERS AND SUPPLIERS ENDPOINTS TESTING COMPLETED SUCCESSFULLY!")
        print("✅ Both endpoints working correctly")
        print("✅ Data structure analyzed for dropdown compatibility")
        print("✅ Company data availability verified")
        print("✅ Backend functionality is working correctly")
        print("\n🔍 RESULTS:")
        print("The endpoints provide company data that can be used for person form dropdowns.")
        print("If dropdowns are not working in the frontend:")
        print("• Check REACT_APP_BACKEND_URL configuration")
        print("• Verify API calls are being made in browser network tab")
        print("• Check frontend dropdown component implementation")
        print("• Verify data mapping from API response to dropdown options")
        print("• Check for JavaScript errors in browser console")
        sys.exit(0)
    else:
        print("\n❌ CUSTOMERS AND SUPPLIERS ENDPOINTS TESTING FAILED!")
        print("Backend API issues found that need to be addressed.")
        print("The dropdown data availability issue may be in the backend.")
        sys.exit(1)