...
const BankCreditCardCategoriesPage = () => {
  ...
  return (
    <div className="p-6">
      <div className="flex items-center mb-6">
        ...
        <h1 className="text-2xl font-bold">Banka & Kredi Kartı Harcama Kategorileri</h1>
      </div>
...
export default BankCreditCardCategoriesPage;
