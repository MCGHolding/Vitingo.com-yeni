...
import CancelledInvoicesPage from './components/Accounting/CancelledInvoicesPage';
    ...
    const loadFairs = async () => {
      try {
        ...
        const backendUrl = (window.ENV && window.ENV.REACT_APP_BACKEND_URL) || 
                          ...
                          'https://crm-invoice-mgr.preview.emergentagent.com';
  ...
  const renderContent = () => {
    switch (currentView) {
      ...
      case 'customer-prospects':
        return <CustomerProspectsPage onBackToDashboard={handleBackToDashboard} />;
      case 'all-people':
        return (
          <AllPeoplePage 
