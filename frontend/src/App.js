          ...
          <div className="min-h-screen bg-gradient-to-br from-purple-900 via-purple-800 to-indigo-900 flex items-center justify-center p-6">
            <div className="bg-white rounded-2xl shadow-2xl p-12 max-w-4xl w-full">
              <div className="text-center mb-8">
                ...
                <h1 className="text-4xl font-bold text-gray-900 mb-2">Ultra Admin Panel</h1>
                <p className="text-gray-600 text-lg">Gelişmiş Sistem Yönetimi</p>
              </div>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8">
                <div className="bg-purple-50 p-6 rounded-xl border-2 border-purple-200">
                  <h3 className="font-semibold text-purple-900 mb-2">Sistem Durumu</h3>
                  <p className="text-sm text-purple-700">Tüm servisler çalışıyor ✅</p>
                </div>
                <div className="bg-blue-50 p-6 rounded-xl border-2 border-blue-200">
                  <h3 className="font-semibold text-blue-900 mb-2">Kullanıcılar</h3>
                  <p className="text-sm text-blue-700">{users.length} aktif kullanıcı</p>
                </div>
                <div className="bg-green-50 p-6 rounded-xl border-2 border-green-200">
                  <h3 className="font-semibold text-green-900 mb-2">Müşteriler</h3>
                  <p className="text-sm text-green-700">{customers.length} kayıtlı müşteri</p>
                </div>
                <div className="bg-orange-50 p-6 rounded-xl border-2 border-orange-200">
                  <h3 className="font-semibold text-orange-900 mb-2">Fırsatlar</h3>
                  <p className="text-sm text-orange-700">{opportunities.length} aktif fırsat</p>
                </div>
              </div>
            ...
            <div className="container mx-auto px-6 py-20 text-center text-white">
              <div className="max-w-4xl mx-auto">
                ...
                <p className="text-2xl mb-8 text-blue-100">
                  Modern İş Yönetimi ve Müşteri İlişkileri Platformu
                </p>
                <p className="text-lg mb-12 text-blue-200">
                  Satış süreçlerinizi optimize edin, müşteri ilişkilerinizi güçlendirin, 
                ...
                <div className="flex gap-4 justify-center mb-16">
                  <button
                    onClick={handleBackToDashboard}
                    className="bg-white text-blue-600 hover:bg-blue-50 px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-200 shadow-lg hover:shadow-xl"
                  >
                    Dashboard'a Git →
                  </button>
                  <button
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
                  <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20">
                    ...
                    <h3 className="text-xl font-semibold mb-3">Satış Yönetimi</h3>
                    <p className="text-blue-100">Fırsatları takip edin, teklifler oluşturun</p>
                  </div>
                  
                  <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20">
                    <div className="text-4xl mb-4">👥</div>
                    <h3 className="text-xl font-semibold mb-3">Müşteri İlişkileri</h3>
                    <p className="text-blue-100">Müşterilerinizi merkezi olarak yönetin</p>
                  </div>
                  
                  <div className="bg-white/10 backdrop-blur-sm p-8 rounded-2xl border border-white/20">
                    <div className="text-4xl mb-4">📈</div>
                    <h3 className="text-xl font-semibold mb-3">Raporlama</h3>
                    <p className="text-blue-100">Detaylı analizler ve raporlar</p>
                  </div>
                </div>
              </div>
            </div>
