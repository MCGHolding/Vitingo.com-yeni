    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 mb-8">
        <div className="flex flex-col sm:flex-row sm:items-center gap-6">
          ...
          {/* Tahsilat İstatistikleri Dashboard */}
          {formData.collectionItems.some(item => parseNumber(item.amount) > 0) && (
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 lg:gap-4">
              
              {/* A) TL Cinsinden Toplam Tahsilat Tutarı (Merkez Bankası Kurlarıyla) */}
              <div className="bg-gradient-to-br from-blue-50 to-blue-100 border border-blue-200 rounded-xl px-4 py-3 shadow-sm hover:shadow-md transition-shadow">
              ...
              {/* B) En Çok Tahsilat Yapan Müşteri Kısa Adı */}
              <div className="bg-gradient-to-br from-green-50 to-green-100 border border-green-200 rounded-xl px-4 py-3 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center space-x-3">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-lg lg:text-xl font-bold text-green-800 truncate">
                      {getTopCustomerShortName()}
                    </p>
              ...
              {/* C) Toplam Tahsilat Adedi */}
              <div className="bg-gradient-to-br from-purple-50 to-purple-100 border border-purple-200 rounded-xl px-4 py-3 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center space-x-3">
              ...
              <div className="bg-gradient-to-br from-orange-50 to-orange-100 border border-orange-200 rounded-xl px-4 py-3 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex items-center space-x-3">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-lg lg:text-xl font-bold text-orange-800">
                      {getAverageCollectionDueDays()}
                    </p>
