              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b border-gray-200">
                    ...
                    <th className="text-left py-3 px-4 font-medium text-gray-600">Kayıp Nedeni</th>
                    <th className="text-left py-3 px-4 font-medium text-gray-600">Kayıp Tarihi</th>
                    ...
                    >
                        ...
                        <div className="space-y-1">
                          <TooltipProvider>
                            <Tooltip>
                              ...
                              <TooltipContent>
                                <p>Kayıp tarihi: {formatDate(opportunity.lostDate)}</p>
                                {opportunity.competitor && (
                                  <p>Rakip: {opportunity.competitor}</p>
                                )}
                              </TooltipContent>
                            </Tooltip>
                          </TooltipProvider>
                      ...
                      <td className="py-4 px-4">
                        <div className="space-y-1">
                          <Badge className="bg-red-100 text-red-800 border-red-300">
                            {opportunity.lostReason || 'Bilinmiyor'}
                          </Badge>
                          {opportunity.competitor && (
                            <div className="text-xs text-gray-500">
                              Rakip: {opportunity.competitor}
                            </div>
                          )}
                        </div>
                      </td>
                      ...
                      <td className="py-4 px-4">
                        <div className="flex items-center space-x-2 text-sm text-gray-600">
                          ...
                          <span>{formatDate(opportunity.lostDate)}</span>
                        </div>
                      </td>
