    ...
    <div className="p-6 max-w-7xl mx-auto">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          <div>
            ...
            <Input
              type="text"
              placeholder="Makbuz no. (son 4 rakam), ödeyen..."
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200">
          <h3 className="text-lg font-semibold text-gray-900">
            Tahsilat Makbuzları ({sortedReceipts.length})
          </h3>
        </div>
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="relative group">
                          <div className="text-sm font-medium text-gray-900 cursor-help">
                            {receipt.payer_name.length > 12 
                              ? receipt.payer_name.substring(0, 12) + '...' 
                              : receipt.payer_name}
                          </div>
          ...
          <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
            <div>
              <p className="text-sm text-gray-700">
                <span className="font-medium">{startIndex + 1}</span> - <span className="font-medium">{Math.min(startIndex + itemsPerPage, sortedReceipts.length)}</span> arası, 
                toplam <span className="font-medium">{sortedReceipts.length}</span> makbuz
              </p>
            </div>
            <div>
              <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                ...
                {totalPages > 5 && currentPage < totalPages - 2 && (
                  <button
                    ...
                    className="relative inline-flex items-center px-2 py-2 text-gray-400 ring-1 ring-inset ring-gray-300 hover:bg-gray-50 focus:z-20 focus:outline-offset-0 ml-2"
                  >
                    >>
                  </button>
                )}
      ...
      <div className="mt-4 px-4 py-2 bg-gray-50 rounded-lg">
        <div className="flex flex-wrap items-center space-x-4 text-xs text-gray-600">
          <span className="font-medium">Ödeme Şekilleri:</span>
          <div className="flex items-center space-x-1">
            <div className="w-4 h-4 rounded-full bg-green-100 text-green-700 flex items-center justify-center text-xs font-semibold">N</div>
            <span>=Nakit</span>
          </div>
          <div className="flex items-center space-x-1">
            <div className="w-4 h-4 rounded-full bg-purple-100 text-purple-700 flex items-center justify-center text-xs font-semibold">Ç</div>
            <span>=Çek</span>
          </div>
          <div className="flex items-center space-x-1">
            <div className="w-4 h-4 rounded-full bg-orange-100 text-orange-700 flex items-center justify-center text-xs font-semibold">B</div>
            <span>=EFT/Havale</span>
          </div>
          <div className="flex items-center space-x-1">
            <div className="w-4 h-4 rounded-full bg-red-100 text-red-700 flex items-center justify-center text-xs font-semibold">S</div>
            <span>=Senet</span>
          </div>
          <div className="flex items-center space-x-1">
            <div className="w-4 h-4 rounded-full bg-blue-100 text-blue-700 flex items-center justify-center text-xs font-semibold">K</div>
