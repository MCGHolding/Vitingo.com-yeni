...
const CategoryCard = ({ category, isParent, isEditing, onEdit, onSave, onCancel, onDelete, onToggle, isExpanded, getSubCategories, editingCategory }) => {
        ...
        <div className="mt-2 space-y-2">
          {subCategories.map(subCat => (
            <CategoryCard 
              ...
              category={subCat} 
              isParent={false} 
              isEditing={editingCategory?.id === subCat.id} 
              onEdit={onEdit} 
              onSave={onSave} 
              onCancel={onCancel} 
              onDelete={onDelete} 
