          ...
          <Card className="mt-8">
            ...
            <CardContent>
              ...
              {currentStep === 8 && (
                <div className="space-y-6">
                  <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600">
                      Standınızda kullanılacak logo ve kurumsal kimlik materyallerinizi yükleyin
                    </p>
                  </div>
                  ...
                  <div className="max-w-4xl mx-auto space-y-8">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="border-2 border-dashed border-gray-300 rounded-lg p-8">
                        <div className="text-center">
                          ...
                          <h4 className="text-lg font-semibold mb-2">Logo Dosyası Yükleyin</h4>
                          <p className="text-gray-600 mb-4">
                            Standınızda kullanılacak firma logonuzu yükleyin (zorunlu)
                          </p>
                          <input
                            type="file"
                            ...
                            onChange={(e) => {
                              ...
                              if (e.target.files[0]) {
                                handleStepDataChange('logoFile', e.target.files[0]);
                                showToast('Logo dosyası yüklendi', 'success');
                              }
                            }}
                            className="hidden"
                            id="logo-upload"
                          ...
                          <p className="text-sm text-gray-500 mt-2">
                            PNG, JPG, SVG, PDF, AI, EPS formatları desteklenir
                          </p>
                          {stepData.logoFile && (
                            <div className="mt-4 p-3 bg-green-50 border border-green-200 rounded-lg">
                              <p className="text-sm text-green-800">
                                ✅ Yüklendi: {stepData.logoFile.name}
                              </p>
                            </div>
                          )}
                        </div>
                    ...
                    {/* Logo Kullanım Talimatları */}
                    <div className="space-y-3">
                      <label className="block text-sm font-medium text-gray-700">
                        Logo Kullanım Talimatları
                      </label>
                      <textarea
                        value={stepData.logoUsageInstructions || ''}
                        onChange={(e) => handleStepDataChange('logoUsageInstructions', e.target.value)}
                        placeholder="Logonuzu nasıl kullanmamız gerektiği hakkında detaylı bilgi veriniz. Örnek: Logo boyutları, renk kullanımı, minimum boyut, yasak kullanımlar, arka plan renkleri vs."
                        rows={6}
                        className="w-full p-4 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 resize-y"
                      />
                      <div className="text-right text-xs text-gray-500">
                        {(stepData.logoUsageInstructions || '').length} karakter
                      </div>
                    </div>

                    {/* Şirket Guideline Dosyası */}
                    <div className="space-y-3">
                      <label className="block text-sm font-medium text-gray-700">
                        Şirket Guideline Dosyası (İsteğe Bağlı)
                      </label>
                      <div className="border-2 border-dashed border-gray-300 rounded-lg p-6">
                        <div className="text-center">
                          <div className="text-3xl mb-3">📄</div>
                          <h4 className="text-lg font-semibold mb-2">Kurumsal Kimlik Rehberi</h4>
                          <p className="text-gray-600 mb-4">
                            Varsa şirket guideline dosyanızı (PDF) yükleyebilirsiniz
                          </p>
                          <input
                            type="file"
                            accept=".pdf"
                            onChange={(e) => {
                              console.log('Guideline file selected:', e.target.files[0]);
                              if (e.target.files[0]) {
                                handleStepDataChange('guidelineFile', e.target.files[0]);
                                showToast('Guideline dosyası yüklendi', 'success');
                              }
                            }}
                            className="hidden"
                            id="guideline-upload"
                          ...
                          {stepData.guidelineFile && (
                            <div className="mt-4 p-3 bg-green-50 border border-green-200 rounded-lg">
                              <p className="text-sm text-green-800">
                                ✅ Yüklendi: {stepData.guidelineFile.name}
                              </p>
                            </div>
                          )}
                        </div>
              ...
              <div className="flex items-center justify-between mt-8 pt-6 border-t">
                ...
                <Button
                  type="button"
                  onClick={currentStep === 9 ? () => setCurrentStep(10) : handleNextStep}
                  disabled={(currentStep === 2 && !canProceedFromStep2()) || (currentStep === 6 && !canProceedFromStep6()) || (currentStep === 7 && !canProceedFromStep7()) || (currentStep === 9 && !canProceedFromStep8())}
              ...
              <div className="text-center space-y-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 max-w-3xl mx-auto">
                  ...
                  <Button
                    type="button"
                    onClick={() => {
                      console.log('Dashboard\'a dön clicked');
                      onBackToDashboard();
                    }}
                    variant="outline"
                    className="py-3"
