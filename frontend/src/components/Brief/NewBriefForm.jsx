              ...
              <CardContent className="p-8">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
                  ...
                  <div className="flex items-center gap-3">
                    <input
                      type="text"
                      readOnly
                      value={`https://smartlibrary-7.preview.emergentagent.com/dashboard#brief-${stepData.briefId}`}
                      className="flex-1 px-3 py-2 border border-gray-300 rounded-md bg-gray-50 text-sm"
                    />
                    <Button
                      type="button"
                      onClick={() => {
                        const link = `https://smartlibrary-7.preview.emergentagent.com/dashboard#brief-${stepData.briefId}`;
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 max-w-3xl mx-auto">
                  ...
                  <Button
                    type="button"
                    onClick={() => {
                      const briefLink = `https://smartlibrary-7.preview.emergentagent.com/dashboard#brief-${stepData.briefId}`;
                    ...
                    <div className="bg-white rounded-lg p-5 shadow-sm border-2 border-blue-200">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                        ...
                        <div>
                          ...
                          <p><strong>Link:</strong> <a href={`https://smartlibrary-7.preview.emergentagent.com/dashboard#brief-${stepData.briefId}`} className="text-blue-600 underline text-xs">Brief'i Görüntüle</a></p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <form onSubmit={(e) => {
                ...
                <div>
                  ...
                  <textarea
                    ...
                    placeholder={`Merhaba,\n\nStand brief dosyamı sizinle paylaşıyorum.\n\nBrief ID: ${stepData.briefId}\nLink: https://smartlibrary-7.preview.emergentagent.com/dashboard#brief-${stepData.briefId}\n\nİyi çalışmalar.`}
                    rows={6}
            ...
            <div className="bg-white rounded-lg w-full max-w-4xl mx-4 max-h-[90vh] overflow-auto shadow-2xl">
              ...
              <div className="p-8 space-y-8">
                ...
                <div className="flex justify-between items-center pt-6 border-t">
                  <div className="text-sm text-gray-500">
                    Brief Link: <a href={`https://smartlibrary-7.preview.emergentagent.com/dashboard#brief-${stepData.briefId}`} 
