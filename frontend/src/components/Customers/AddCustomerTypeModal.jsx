...
const AddCustomerTypeModal = ({ onClose, onSave, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!customerTypeName.trim()) {
      alert('Müşteri türü adı gereklidir');
      return;
    }
    ...
    try {
      ...
      const value = customerTypeName.toLowerCase()
        .replace(/\s+/g, '_')
        .replace(/[^a-z0-9_]/g, '');
      ...
      if (response.ok) {
        ...
        alert('Hata: ' + (errorData.detail || 'Müşteri türü kaydedilemedi'));
      }
    } catch (error) {
      console.error('Error creating customer type:', error);
      alert('Müşteri türü kaydedilirken hata oluştu: ' + error.message);
    } finally {
      setIsLoading(false);
    }
  };
        ...
        <div className="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-white">
          ...
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-4">
              <strong>{createdType?.name}</strong> müşteri türü başarıyla eklendi.
            </p>
            
            <div className="bg-green-50 border border-green-200 rounded-lg p-3 mb-4">
              <p className="text-green-800 text-sm">
                ✅ Yeni müşteri türü artık dropdown menüsünde görünecek.
              </p>
            </div>
          ...
          <CardHeader className="border-b border-gray-200">
            <div className="flex items-center justify-between">
              <CardTitle className="text-lg font-semibold text-gray-800 flex items-center space-x-2">
                ...
                <span>Yeni Müşteri Türü Ekle</span>
              </CardTitle>
              <Button
                variant="ghost"
                size="sm"
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <Input
                  ...
                  placeholder="Örn: Holding, Kooperatif, Vakıf..."
                  className="w-full"
                  disabled={isLoading}
                  required
                />
                <p className="text-xs text-gray-500 mt-1">
                  Yeni müşteri türü adını girin
                </p>
              </div>
              ...
              <div className="flex justify-end space-x-3 pt-4 border-t border-gray-200">
                ...
                <Button
                  ...
                  disabled={isLoading || !customerTypeName.trim()}
                >
